          ...
          <section className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-32 lg:px-8 lg:py-40 overflow-hidden" aria-labelledby="hero-heading">
            ...
            <div className="relative text-center">
              ...
              <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row animate-fade-in-up" style={{animationDelay: '0.4s'}}>
                <a
                  href="https://wa.me/917394840630?text=Hi%20Elite%20Solutions!%20I'm%20interested%20in%20your%20services.%20Can%20we%20discuss%20my%20project?"
                  target="_blank"
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-2 max-w-4xl mx-auto">
                <article className="card-hover shine group relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[#1A1F35] via-[#141829] to-[#0F1421] p-8">
                  ...
                  <a
                    href="https://wa.me/917394840630?text=Hi%20Elite%20Solutions!%20I'm%20interested%20in%20Website%20Development%20(starting%20from%20₹9,999).%20Let's%20discuss!"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <article className="card-hover shine group relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[#1A1F35] via-[#141829] to-[#0F1421] p-8">
                  ...
                  <a
                    href="https://wa.me/917394840630?text=Hi%20Elite%20Solutions!%20I'm%20interested%20in%20Google%20Ads%20(starting%20from%20₹3,999).%20Let's%20discuss!"
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              <div className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 via-blue-500 to-purple-600 p-12 shadow-2xl animate-gradient sm:p-16 lg:p-20">
                ...
                <div className="relative text-center">
                  ...
                  <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-6">
                    <a
                      href="https://wa.me/917394840630?text=Hi%20Elite%20Solutions!%20I'm%20ready%20to%20start%20my%20project.%20Let's%20discuss!"
            target="_blank"
            rel="noopener noreferrer"
                  ...
                  <div className="mt-12 flex flex-wrap items-center justify-center gap-6 border-t border-white/20 pt-8">
                    ...
                    <a href="https://wa.me/917394840630" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-white/90 hover:text-green-400 transition-colors">
                      <div className="rounded-lg bg-white/20 p-2 backdrop-blur-sm">
                        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z" />
                        </svg>
                      </div>
                      <span className="text-sm font-medium">WhatsApp: +91 7394840630</span>
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="flex flex-col items-center gap-3 sm:flex-row sm:gap-4">
                ...
                <span className="hidden text-gray-600 sm:block">|</span>
                <a href="https://wa.me/917394840630" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-gray-400 hover:text-green-400 transition-colors">
