            ...
            <div className="mx-auto max-w-4xl">
              <div className="rounded-3xl bg-gradient-to-br from-blue-600 via-blue-500 to-blue-600 p-8 text-center shadow-2xl sm:p-12">
                ...
                <p className="mx-auto mt-4 max-w-xl text-sm text-blue-100 sm:text-base">
                  Chat with our experts on WhatsApp to discuss your project goals and discover how we can help.
                </p>
                <div className="mt-8">
                  <a
                    href="https://wa.me/917739100259?text=Hi%20Elite%20Solutions!%20I%20would%20like%20to%20book%20a%20free%20consultation.%20Let's%20discuss%20my%20project!"
                    target="_blank"
