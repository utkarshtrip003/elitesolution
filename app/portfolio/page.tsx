...
export const metadata: Metadata = {
  ...
  description: "Explore our portfolio of successful web development and digital marketing projects. See how we've helped businesses grow online.",
  openGraph: {
    title: "Our Portfolio - Elite Solutions",
...
const projects = [
  {
    ...
    description: "A comprehensive sports platform featuring event management, team registration, and live updates. Built with modern web technologies for optimal performance.",
  ...
  },
  {
    id: "2",
    title: "LL Fitness",
    description: "A premium fitness center website for Gurugram's premier gym. Features facility gallery, class schedules, membership information, and seamless contact integration.",
